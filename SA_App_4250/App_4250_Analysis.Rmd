...
g1 <- ggplot(Ref %>% filter(Seg != "0_out_range")) + 
  geom_density(aes(HHI_E, col ="HHI_E")) +
  geom_density(aes(HHI_S, col ="HHI_S")) +
  ggtitle("All Entr & Sor")
...
g2 <- ggplot(t2) + 
  geom_density(aes(HHI, col = Tag)) + 
  ggtitle("First Entr & Last Sor")

grid.arrange(g1,g2, ncol = 2, main = "HHI for all")
```
...
grid.arrange(g1,g2, ncol = 2, main = "HHI by segment")
```

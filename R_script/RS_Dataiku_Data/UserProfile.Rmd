---
title: "UserProfile in Vaucluse - ID2"
date: "Wednesday, May 21, 2015"
output: html_document
---

# User Profile in Vaucluse - ID2
## This page shows the profile of user 'ID2'
...
```{r, fig.width= 10, fig.height=4, echo=FALSE,cache=TRUE}
ID2_gare<-ID2_gare
ggplot(ID2_gare,aes(x=Sor))+  geom_bar(binwidth=100) +
  xlim(c(4000,6100))
ggplot(ID2_gare,aes(x=Sor))+  geom_bar(aes(y = (..count..)/sum(..count..)),binwidth=.5) +  
